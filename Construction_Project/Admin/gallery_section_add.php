...
?>
 ...
 -->
                ...
                <div class="col-12">
                  <label for="img" class="form-label">Remodeling</label>
                  <input type="file" class="form-control" name="img" accept=".png,.jpg,.jpeg" >
                </div>
                <div class="col-12">
                  <label for="img" class="form-label">Construction</label>
                  <input type="file" class="form-control" name="img" accept=".png,.jpg,.jpeg" >
                </div>
                <div class="col-12">
                  <label for="img" class="form-label">Repairs</label>
                  <input type="file" class="form-control" name="img" accept=".png,.jpg,.jpeg" >
                </div>
                <div class="col-12">
                  <label for="img" class="form-label">Design</label>
                  <input type="file" class="form-control" name="img" accept=".png,.jpg,.jpeg" >
                </div>
